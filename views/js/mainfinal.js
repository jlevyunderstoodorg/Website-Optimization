...
var resizePizzas = function(size) { 
 ...
 function changePizzaSizes(size) {
  // I moved query outside of the for loop to reduce the number of calls
  // I changed querySelectAll to getElementsByClassName to reduce number of queries
  // I added two variables to help make it go faster as well
...
var pizzasDiv = document.getElementById("randomPizzas"); // added this outside loop after first review
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  // stored calculations in new variable
  // changed querySelectorAll to getElementsByClassName to make it faster
  // used new variable here to cache the pizzas
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // dynamically calculating the number of pizzas needed to fill the screen based on browser window resolution
  ...
  // decreased the amount of pizzas to 40
  for (var i = 0; i < 40; i++) {
